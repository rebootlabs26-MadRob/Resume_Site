...
<main class="page">
  ...
  <section class="hero fade-in">
    ...
    <p class="hero-intro">
      I’m an IT and electronics professional with over a decade of experience in repair, diagnostics,
      system troubleshooting, and workflow engineering. Alongside my professional roles, I’ve built out a
      personal technical lab focused on diagnostic platforms, monitoring dashboards, structured repair
      processes, and remote‑friendly workflows. This site showcases my resume and some of the tools and
      systems I’ve been designing.
    </p>
  </section>
  ...
  <section id="styles" class="fade-in">
    ...
    <div class="card">
      <p class="muted">
        These are the different ways I can tailor my experience depending on the role. Each style pulls from the
        same core background, with a different focus.
      </p>
      <details open>
